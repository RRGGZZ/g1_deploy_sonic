...
def convert_scalelab_motion(motion_name: str, motion_data: dict, target_fps: float) -> dict:
    ...
    root_rot_resampled_wxyz = xyzw_to_wxyz(root_rot_resampled_xyzw)

    joint_vel = finite_difference(joint_pos, target_fps)
...
def convert_motion_dict(motion_name: str, motion_data: dict, target_fps: float) -> dict:
    if is_scalelab_motion_dict(motion_data):
        return convert_scalelab_motion(motion_name, motion_data, target_fps)
...
def convert_pickle_file(
    ...
    for motion_name, motion_dict in motions.items():
        ...
        converted_motion = convert_motion_dict(motion_name, motion_dict, target_fps)
